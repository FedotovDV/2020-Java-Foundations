...
public class Main {
    ...
    public static class Thief implements MailService {
        ...
        public Sendable processMail(Sendable mail) {
            if (mail instanceof MailPackage) {
                if (((MailPackage) mail).getContent().getPrice() > mailCost) {
    ...
    public static class Inspector implements MailService {
        ...
        public Sendable processMail(Sendable mail) {
            if (mail instanceof MailPackage) {
                if (((MailPackage) mail).getContent().getContent().contains("stone")) {
                    throw new StolenPackageException();
                } else if (((MailPackage) mail).getContent().getContent().contains(WEAPONS) ||
    ...
    public static void main(String[] args) {
        ...
        AbstractSendable[] correspondence = {
                ...
                new MailPackage(AUSTIN_POWERS, "Жопа запрещенная группировка", new Package("weapons tiny bomb", 9000)),
